...
public class InformationLevel2Controller : MonoBehaviour
{
    // Mètode que es crida quan es prem el botó "Continuar".
    public void StartPlaying()
    {
        // Carrega l'escena del nivell 2 mitjançant el GameManager.
        GameManager.gameInstance.SceneLoad((int)GameManager.GameScene.LEVEL_2);
    }
}